...
The two **must have** tools to create easy-to-use CI/CD templating system (using github actions).


Example of the action to automatically create PRs to sync a project with a boilerplate:
```yaml
